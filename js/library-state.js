(function () {
  ...
  function storyKey(story) {
    return (story.href || 'story-detail.html') + '::' + (story.title || 'story');
  }
  ...
  function buildStoryData(source) {
    ...
    if (!href) {
      ...
      href = id ? ('story-detail.html?id=' + encodeURIComponent(String(id))) : 'story-detail.html';
    }
  ...
  function hydrateDetailStoryIdentity() {
    ...
    if ((!href || href === 'story-detail.html') && id) detail.setAttribute('href', 'story-detail.html?id=' + encodeURIComponent(String(id)));
  }
